...
INPUT_DIR=./input
OUTPUT_DIR=./rio
vrtfile=${OUTPUT_DIR}/jaxa_tilergb0-14.vrt
mbtiles=${OUTPUT_DIR}/jaxa_tilergb0-14.mbtiles
vrtfile2=${OUTPUT_DIR}/jaxa_tilergb0-14_warp.vrt
...
rio rgbify -b -10000 -i 0.1 --min-z 0 --max-z 14 -j 24 --format png ${vrtfile2} ${mbtiles}
