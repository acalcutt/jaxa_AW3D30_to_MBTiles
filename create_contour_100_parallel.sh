...
prun()
{
	...
	INPUT_DIR=./input
	JSON_OUTPUT_DIR=/opt/jaxa_AW3D30_to_MBTiles/json_100
	SHP_OUTPUT_DIR=/opt/jaxa_AW3D30_to_MBTiles/json_100/shp
	...
	#gdal_contour -a elev -i 100 -f "GeoJSON" ${filename} ${json} #note - this geojson did not work right with tippecanoe. output came out one long line.
