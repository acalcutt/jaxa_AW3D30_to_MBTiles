...
MINZOOM=0
MAXZOOM=11
vrtfile=${OUTPUT_DIR}/jaxa_terrarium_${MINZOOM}-${MAXZOOM}.vrt
mbtiles=${OUTPUT_DIR}/jaxa_terrarium_${MINZOOM}-${MAXZOOM}.mbtiles
vrtfile2=${OUTPUT_DIR}/jaxa_terrarium_${MINZOOM}-${MAXZOOM}_warp.vrt
...
sqlite3 ${mbtiles} 'UPDATE metadata SET value = "jaxa_terrarium_'${MINZOOM}'-'${MAXZOOM}'" WHERE name = "name" AND value = "";'
